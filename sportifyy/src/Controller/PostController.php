...
if ($searchQuery && $searchField) {
    if ($searchField == 'titre_Post') {
        $queryBuilder->where('p.titre_Post LIKE :searchQuery')
            ->setParameter('searchQuery', '%'.$searchQuery.'%');
    } elseif ($searchField == 'id') {
        $queryBuilder->where('p.id LIKE :searchQuery')
            ->setParameter('searchQuery', '%'.$searchQuery.'%');
    } elseif ($searchField == 'likes') {
        $queryBuilder->where('p.Likes LIKE :searchQuery')
            ->setParameter('searchQuery', '%'.$searchQuery.'%');
    }elseif ($searchField == 'dateCreation_Post') {
        $queryBuilder->where('p.dateCreation_Post LIKE :searchQuery')
            ->setParameter('searchQuery', '%'.$searchQuery.'%');
    }elseif ($searchField == 'auteur_Post') {
        $queryBuilder->where('p.auteur_Post LIKE :searchQuery')
            ->setParameter('searchQuery', '%'.$searchQuery.'%');
    }
}
